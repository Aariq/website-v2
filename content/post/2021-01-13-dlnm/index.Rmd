...
The great thing about the `dlnm` package, is that it allows you to fit these crossbasis functions in the context of a GAM and take advantage of a lot of the great stuff the `mgcv` package offers. The bad thing is that all of this is very new. And when I say "all of this" I mean DLNMs, DLNMs fit using GAMs, and even GAMs themselves. Heck, it was only in [2016](https://doi.org/10.1080/01621459.2016.1180986) when Simon Wood and colleagues answered the question "How to get unbiased AIC values for GAMs?".
