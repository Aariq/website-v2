...
The reference degrees of freedom `Ref.df` is, I think, another way of calculating the edf, but honestly, the explanation in the help file and associated paper is beyond my understanding.[^3]
...
[^3]: Wood SN (2013) On p-values for smooth components of an extended generalized additive model.
    Biometrika 100:221--228 .
    <https://doi.org/10.1093/biomet/ass048>
